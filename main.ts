...
function spawnbossspider () {
    ...
    bosshealth = statusbars.create(20, 6, StatusBarKind.Health)
    bosshealth.value = 20
...
game.onUpdateInterval(2500, function () {
    if (bossexist == 1) {
        music.play(music.createSoundEffect(WaveShape.Triangle, 249, 1, 255, 255, 1000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
