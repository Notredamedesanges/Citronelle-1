...
function bossspiderdies () {
    bossexist = 0
    bigspider1.follow(hero, 0)
    bigspider1.ay = 300
...
function spawnbossspider () {
    ...
    bigspider1.follow(hero, 13)
    bosshealth = statusbars.create(30, 8, StatusBarKind.EnemyHealth)
    bosshealth.max = 30
    bosshealth.value = 30
    bosshealth.attachToSprite(bigspider1)
    bossexist = 1
}
...
sprites.onOverlap(SpriteKind.spiderattack, SpriteKind.Player, function (sprite, otherSprite) {
    deathfrompurplespit()
})
...
info.onScore(3, function () {
    info.setScore(0)
    sprites.destroyAllSpritesOfKind(SpriteKind.apples)
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.boss, function (sprite, otherSprite) {
    bigspider1.setKind(SpriteKind.ghost)
    bigspider1.follow(hero, 0)
    music.play(music.createSoundEffect(WaveShape.Noise, 2314, 977, 255, 0, 1000, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    animation.runImageAnimation(
    bigspider1,
    [img`
        ....................
    ...
    pause(500)
    bosshealth.value += -1
    bigspider1.setKind(SpriteKind.boss)
    if (bosshealth.value == 0) {
        bossspiderdies()
    }
    bigspider1.follow(hero, 15)
})
...
scene.setBackgroundImage(img`
    ...
    
    ...
    
...
game.onUpdateInterval(2000, function () {
    if (bossexist == 1) {
        music.play(music.createSoundEffect(WaveShape.Noise, 5000, 1, 95, 95, 300, SoundExpressionEffect.Tremolo, InterpolationCurve.Logarithmic), music.PlaybackMode.InBackground)
        ...
        purplespit.setFlag(SpriteFlag.DestroyOnWall, true)
        purplespit.setPosition(bigspider1.x, bigspider1.y)
        animation.runImageAnimation(
        purplespit,
        [img`
            ....................
